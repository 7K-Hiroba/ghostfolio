...
Helm chart for ghostfolio.

This chart installs the workload (Deployment, Service, HPA, PDB, HTTPRoute). For cross-cutting platform dependencies (secrets, observability, databases), install the companion [ghostfolio-platform](../platform/README.md) chart.
