...
Platform dependencies for the [ghostfolio](../base/README.md) chart — provisions the cross-cutting resources the workload needs but that aren't part of its lifecycle.
